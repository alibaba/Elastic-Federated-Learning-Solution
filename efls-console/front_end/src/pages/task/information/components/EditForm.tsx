...
import {  sampleConfigTips } from '@/pages/projects/components/configConst';
...
const EditForm: React.FC<EditFormProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      {mode == "add" && <>
        <Form.Item name="name" label="数据任务名称">
          <Input disabled />
        </Form.Item>
      ...
      <Form.Item
        name="config"
        label="内部配置"
        tooltip={{title:sampleConfigTips,overlayStyle:{maxWidth:'600px'}}}
        rules={[
          {

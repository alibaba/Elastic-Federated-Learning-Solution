...
_EFLS_START_TRAIN_JOB_SCRIPT = '/efl/train/start_non_federal_train.sh'

class NonFederalTrainerScheduler(TrainerScheduler):
...
def init_trainer_scheduler(k8s_config, cert_file_path, docker_secret, ingress_cert_name):
    ...
    if _EFLS_TRAINER_SCHEDULER is None:
        _EFLS_TRAINER_SCHEDULER = NonFederalTrainerScheduler(
            k8s_config,
            cert_file_path,
            docker_secret,
            ingress_cert_name)

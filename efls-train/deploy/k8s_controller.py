...
class K8sController():
    ...
    def __init__(self, kube_config=None):
        ...
        self._networkv1api = client.NetworkingV1Api()
    ...
    # def get_logs(self, job_name, task_name, task_index, namespace='default'):
    #     pod_names = self.get_job_pod_names(job_name, namespace=namespace)
    ...
    def delete_ingress(self, ingress_name, namespace='default'):
        try:
            self._networkv1api.delete_namespaced_ingress(ingress_name, namespace=namespace)
        except ApiException as e:
